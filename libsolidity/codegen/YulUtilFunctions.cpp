...
string YulUtilFunctions::combineExternalFunctionIdFunction()
{
	...
	return m_functionCollector.createFunction(
		...
		)")("functionName", functionName)("shl32", shiftLeftFunction(32))("shl64", shiftLeftFunction(64))
				.render();
		});
}
...
string YulUtilFunctions::splitExternalFunctionIdFunction()
{
	...
	return m_functionCollector.createFunction(
		...
		)")("functionName", functionName)("shr32", shiftRightFunction(32))("shr64", shiftRightFunction(64))
				.render();
		});
}
		...
		[&]()
		{
			...
			function <functionName>() -> memPtr {
				...
				<storeLiteralInMem>(add(memPtr, 32))
					   ...
					   allocateMemoryArrayFunction(*TypeProvider::array(DataLocation::Memory, true)))(
					   "size", to_string(_literal.size()))("storeLiteralInMem", storeLiteralInMemoryFunction(_literal))
				.render();
		});
}
...
string YulUtilFunctions::storeLiteralInMemoryFunction(string const& _literal)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			)")("functionName", functionName)("word", wordParams)
				.render();
		});
}
			...
			if (_literal.size() >= 32)
			{
				...
				<#word>
					sstore(add(dstPtr, <offset>), <wordValue>)
						   ...
						   "dataArea", arrayDataAreaFunction(*TypeProvider::bytesStorage()))("word", wordParams)(
						   "length", to_string(_literal.size()))("encodedLen", to_string(2 * _literal.size() + 1))
					.render();
			}
			else
				return Whiskers(R"(
				...
				sstore(slot, add(<wordValue>, <encodedLen>))
						   ...
						   "cleanUpArrayEnd",
						   cleanUpDynamicByteArrayEndSlotsFunction(
							   *TypeProvider::bytesStorage()))("wordValue", formatAsStringOrNumber(_literal))(
						   "length", to_string(_literal.size()))("encodedLen", to_string(2 * _literal.size()))
					.render();
		});
}
		...
		[&]()
		{
			if (!_messageType)
				...
				function <functionName>(condition) {
					...
					_assert ? panicFunction(PanicCode::Assert) + "()" : "revert(0, 0)")("functionName", functionName)
					.render();
			...
			function <functionName>(condition <messageVars>) {
				...
				functionName)("allocateUnbounded", allocateUnboundedFunction())("errorHash", formatNumber(errorHash))(
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			function <functionName>(value) -> newValue {
				...
				functionName)("numBits", to_string(_numBits))("hasShifts", m_evmVersion.hasBitwiseShifting())(
			...
			function <functionName>(value) -> newValue {
				...
				<!hasShifts>
					div(value, <multiplier>)
					   ...
					   "numBits", to_string(_numBits))("multiplier", toCompactHexWithPrefix(u256(1) << _numBits))
				.render();
		});
}
		...
		[&]()
		{
			...
			function <functionName>(value, bits) -> result {
				...
				result := <cleanup>(<shift>(bits, <cleanup>(value)))
					   ...
					   "shift", shiftLeftFunctionDynamic())("cleanup", cleanupFunction(_type))
				.render();
		});
}
		...
		[&]()
		{
			...
			function <functionName>(value, bits) -> result {
				...
				result := <cleanup>(<shift>(bits, <cleanup>(value)))
					   ...
					   "shift",
					   valueSigned ? shiftRightSignedFunctionDynamic()
								   : shiftRightFunctionDynamic())("cleanup", cleanupFunction(_type))
				.render();
		});
}
...
string YulUtilFunctions::updateByteSliceFunction(size_t _numBytes, size_t _shiftBytes)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			)")("functionName", functionName)("mask", formatNumber(((bigint(1) << numBits) - 1) << shiftBits))(
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			function <functionName>(value, shiftBytes, toInsert) -> result {
				...
				functionName)("mask", formatNumber((bigint(1) << numBits) - 1))("shl", shiftLeftFunctionDynamic())
				.render();
		});
}
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			function <functionName>(data) -> result {
				result := and(data, <mask>)
			})")("functionName", functionName)("mask", formatNumber((~u256(0)) >> (256 - 8 * _bytes)))
				.render();
		});
}
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			function <functionName>(data, bytes) -> result {
				...
				result := and(data, mask)
			})")("functionName", functionName)("shl", shiftLeftFunctionDynamic())
				.render();
		});
}
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			function <functionName>(x, y) -> sum {
				...
				functionName)("signed", _type.isSigned())("maxValue", toCompactHexWithPrefix(u256(_type.maxValue())))(
					   "minValue", toCompactHexWithPrefix(u256(_type.minValue())))(
					   "cleanupFunction", cleanupFunction(_type))("panic", panicFunction(PanicCode::UnderOverflow))
				.render();
		});
}
...
string YulUtilFunctions::wrappingIntAddFunction(IntegerType const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			)")("functionName", functionName)("cleanupFunction", cleanupFunction(_type))
				.render();
		});
}
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			function <functionName>(x, y) -> r {
				...
				functionName)("signed", _type.isSigned())("minVal", toCompactHexWithPrefix(u256(_type.minValue())))(
					   "cleanupFunction",
					   cleanupFunction(_type))("panicDivZero", panicFunction(PanicCode::DivisionByZero))(
...
string YulUtilFunctions::wrappingIntDivFunction(IntegerType const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			)")("functionName", functionName)("cleanupFunction", cleanupFunction(_type))("signed", _type.isSigned())(
...
string YulUtilFunctions::intModFunction(IntegerType const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			)")("functionName", functionName)("signed", _type.isSigned())("cleanupFunction", cleanupFunction(_type))(
...
string YulUtilFunctions::overflowCheckedIntExpFunction(IntegerType const& _type, IntegerType const& _exponentType)
{
				...
				<!signed>
					power := <exp>(base, exponent, <maxValue>)
					   ...
					   _type.isSigned()
						   ...
						   : overflowCheckedUnsignedExpFunction())("maxValue", toCompactHexWithPrefix(_type.max()))(
					   "minValue", toCompactHexWithPrefix(_type.min()))("baseCleanupFunction", cleanupFunction(_type))(
...
string YulUtilFunctions::overflowCheckedIntLiteralExpFunction(
	RationalNumberType const& _baseType, IntegerType const& _exponentType, IntegerType const& _commonType)
{
	solAssert(!_exponentType.isSigned(), "");
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			bigint baseValue
				= _baseType.isNegative() ? u2s(_baseType.literalValue(nullptr)) : _baseType.literalValue(nullptr);
				...
				if (needsOverflowCheck)
					solAssert(
						(power <= _commonType.maxValue()) && (power >= _commonType.minValue())
							&& !(
								(overflowedPower <= _commonType.maxValue())
								&& (overflowedPower >= _commonType.minValue())),
			...
			)")("functionName", functionName)("exponentCleanupFunction", cleanupFunction(_exponentType))(
					   "needsOverflowCheck", needsOverflowCheck)("exponentUpperbound", to_string(exponentUpperbound))(
					   "panic", panicFunction(PanicCode::UnderOverflow))("base", bigint2u(baseValue).str())
				.render();
		});
}
...
string YulUtilFunctions::overflowCheckedUnsignedExpFunction()
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			)")("functionName", functionName)("panic", panicFunction(PanicCode::UnderOverflow))(
		...
		[&]()
		{
			...
			function <functionName>(base, exponent, min, max) -> power {
				...
				power := mul(power, base)
					   ...
					   "expLoop", overflowCheckedExpLoopFunction())("shr_1", shiftRightFunction(1))
				.render();
		});
}
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			function <functionName>(_power, _base, exponent, max) -> power, base {
				...
				functionName)("panic", panicFunction(PanicCode::UnderOverflow))("shr_1", shiftRightFunction(1))
				.render();
		});
}

string YulUtilFunctions::wrappingIntExpFunction(IntegerType const& _type, IntegerType const& _exponentType)
{
	solAssert(!_exponentType.isSigned(), "");
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			)")("functionName", functionName)("baseCleanupFunction", cleanupFunction(_type))(
					   "exponentCleanupFunction", cleanupFunction(_exponentType))
				.render();
		});
}
...
string YulUtilFunctions::cleanUpStorageArrayEndFunction(ArrayType const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		)")("convertToSize", arrayConvertLengthToSize(_type))("dataPosition", arrayDataAreaFunction(_type))(
					   "clearStorageRange",
					   clearStorageRangeFunction(*_type.baseType()))("packed", _type.baseType()->storageBytes() <= 16)(
					   "itemsPerSlot", to_string(32 / _type.baseType()->storageBytes()))(
					   "storageBytes",
					   to_string(_type.baseType()
									 ->storageBytes()))("partialClearStorageSlot", partialClearStorageSlotFunction())
				.render();
		});
}
...
string YulUtilFunctions::resizeDynamicByteArrayFunction(ArrayType const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		)")("extractLength", extractByteArrayLengthFunction())("decreaseSize", decreaseByteArraySizeFunction(_type))(
...
string YulUtilFunctions::cleanUpDynamicByteArrayEndSlotsFunction(ArrayType const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		)")("dataLocation", arrayDataAreaFunction(_type))("div32Ceil", divide32CeilFunction())(
...
string YulUtilFunctions::decreaseByteArraySizeFunction(ArrayType const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			})")("functionName", functionName)("dataPosition", arrayDataAreaFunction(_type))(
					   "partialClearStorageSlot", partialClearStorageSlotFunction())(
					   "clearStorageRange",
					   clearStorageRangeFunction(
						   *_type.baseType()))("transitLongToShort", byteArrayTransitLongToShortFunction(_type))(
					   "div32Ceil",
					   divide32CeilFunction())("encodeUsedSetLen", shortByteArrayEncodeUsedAreaSetLengthFunction())
				.render();
		});
}
...
string YulUtilFunctions::increaseByteArraySizeFunction(ArrayType const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		)")("panic", panicFunction(PanicCode::ResourceError))("maxArrayLength", (u256(1) << 64).str())(
					   "dataPosition",
...
string YulUtilFunctions::shortByteArrayEncodeUsedAreaSetLengthFunction()
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			})")("functionName", functionName)("maskBytes", maskBytesFunctionDynamic())
				.render();
		});
}
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			function <functionName>(array) {
				...
				sstore(array, newLen)
			})")("functionName", functionName)("panic", panicFunction(PanicCode::EmptyArrayPop))(
					   "fetchLength",
					   arrayLengthFunction(_type))("indexAccess", storageArrayIndexAccessFunction(_type))(
					   "setToZero",
			...
			function <functionName>(array) {
				...
				default {
					...
					default {
					   ...
					   "transitLongToShort",
					   byteArrayTransitLongToShortFunction(
						   _type))("encodeUsedSetLen", shortByteArrayEncodeUsedAreaSetLengthFunction())(
...
string YulUtilFunctions::storageArrayPushFunction(ArrayType const& _type, Type const* _fromType)
{
	...
	string functionName = string{"array_push_from_"} + _fromType->identifier() + "_to_" + _type.identifier();
	return m_functionCollector.createFunction(
		functionName,
		[&]()
		{
			...
			function <functionName>(array <values>) {
				...
				<!isByteArray>
					...
					<storeValue>(slot, offset <values>)
					   ...
					   "values",
					   _fromType->sizeOnStack() == 0
						   ? ""
						   : ", " + suffixedVariableNameList("value", 0, _fromType->sizeOnStack()))(
					   ...
					   storageArrayIndexAccessFunction(
						   _type))("storeValue", updateStorageValueFunction(*_fromType, *_type.baseType()))(
					   "maxArrayLength", (u256(1) << 64).str())("shl", shiftLeftFunctionDynamic())
				.render();
		});
}
...
string YulUtilFunctions::storageArrayPushZeroFunction(ArrayType const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			})")("functionName", functionName)("isBytes", _type.isByteArray())(
					   "increaseBytesSize",
					   _type.isByteArray()
						   ? increaseByteArraySizeFunction(_type)
						   : "")("extractLength", _type.isByteArray() ? extractByteArrayLengthFunction() : "")(
					   "panic", panicFunction(PanicCode::ResourceError))("fetchLength", arrayLengthFunction(_type))(
					   "indexAccess", storageArrayIndexAccessFunction(_type))("maxArrayLength", (u256(1) << 64).str())
				.render();
		});
}
	...
	return m_functionCollector.createFunction(
		...
		function <functionName>(slot, offset) {
			...
			sstore(slot, and(mask, sload(slot)))
				...
				functionName)("ones", formatNumber((bigint(1) << 256) - 1))("shr", shiftRightFunctionDynamic())
				.render();
		});
}
				...
				for {} lt(start, end) { start := add(start, <increment>) }
				{
					<setToZero>(start, 0)
					   ...
					   storageSetToZeroFunction(
						   _type.storageBytes() < 32 ? *TypeProvider::uint256()
													 : _type))("increment", _type.storageSize().str())
				.render();
		});
}
			...
			function <functionName>(slot) {
				...
				<!dynamic>
					<?+clearRange><clearRange>(slot, add(slot, <lenToSize>(<len>)))</+clearRange>
					   ...
					   _type.baseType()->category() != Type::Category::Mapping
						   ? clearStorageRangeFunction(
							   (_type.baseType()->storageBytes() < 32) ? *TypeProvider::uint256() : *_type.baseType())
...
string YulUtilFunctions::clearStorageStructFunction(StructType const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]
		{
			...
			for (auto const& member: structMembers)
			{
				...
				if (member.type->storageBytes() < 32)
				{
					...
					if (!slotsCleared.count(slotDiff))
					{
						memberSetValues.emplace_back()
							.emplace("clearMember", "sstore(add(slot, " + slotDiff.str() + "), 0)");
				...
				else
				{
					...
					)")("setZero", storageSetToZeroFunction(*member.type))("memberSlotDiff", memberSlotDiff.str())(
		...
		)")("functionName", functionName)("member", memberSetValues)
				.render();
		});
}
...
{
	solAssert(
		*_fromType.copyForLocation(_toType.location(), _toType.isPointer())
			== dynamic_cast<ReferenceType const&>(_toType),
		"");
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			templ(
				"elementValues",
				suffixedVariableNameList("elementValue_", 0, _fromType.baseType()->stackItems().size()));
			templ("updateStorageValue", updateStorageValueFunction(*_fromType.baseType(), *_toType.baseType()));
			templ(
				"srcStride",
				fromCalldata ? to_string(_fromType.calldataStride())
				: fromMemory ? to_string(_fromType.memoryStride())
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			<!srcReadMultiPerSlot>
				...
				!sameType
					&& _fromType.storageStride() <= 16)("srcItemsPerSlot", to_string(32 / _fromType.storageStride()))
					.render());
				...
				return Whiskers(R"(
					function <functionName>(length) -> size {
						...
						<!multiSlot>
						   ...
						   "itemsPerSlot",
						   to_string(32 / baseStorageBytes))("storageSize", baseType.storageSize().str())(
				...
				return Whiskers(R"(
					function <functionName>(length) -> size {
						...
						<!byteArray>
						   ...
						   "byteArray",
						   _type.isByteArray())("mul", overflowCheckedIntMulFunction(*TypeProvider::uint256()))
					.render();
			default:
				solAssert(false, "");
			}
			...
			function <functionName>(ptr) -> data {
				...
				<?dynamic>
					...
					<?storage>
					   ...
					   "memory",
					   _type.location() == DataLocation::Memory)("storage", _type.location() == DataLocation::Storage)
				.render();
		});
}
...
string YulUtilFunctions::storageArrayIndexAccessFunction(ArrayType const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		)")("functionName", functionName)("panic", panicFunction(PanicCode::ArrayOutOfBounds))(
					   "arrayLen", arrayLengthFunction(_type))("dataAreaFunc", arrayDataAreaFunction(_type))(
					   "indexAccessNoChecks", longByteArrayStorageIndexAccessNoCheckFunction())(
					   "multipleItemsPerSlot", _type.baseType()->storageBytes() <= 16)(
					   "isBytesArray", _type.isByteArray())("storageSize", _type.baseType()->storageSize().str())(
					   "storageBytes",
					   toString(_type.baseType()
									->storageBytes()))("itemsPerSlot", to_string(32 / _type.baseType()->storageBytes()))
				.render();
		});
}
		...
		[&]()
		{
			...
			function <functionName>(baseRef, index) -> addr {
				...
				addr := add(baseRef, offset)
					   ...
					   "arrayLen", arrayLengthFunction(_type))("stride", to_string(_type.memoryStride()))(
			...
			function <functionName>(base_ref<?dynamicallySized>, length</dynamicallySized>, index) -> addr<?dynamicallySizedBase>, len</dynamicallySizedBase> {
				...
				<?dynamicallyEncodedBase>
					addr<?dynamicallySizedBase>, len</dynamicallySizedBase> := <accessCalldataTail>(base_ref, addr)
					   ...
					   "stride", to_string(_type.calldataStride()))("dynamicallySized", _type.isDynamicallySized())(
					   "dynamicallyEncodedBase", _type.baseType()->isDynamicallyEncoded())(
					   "dynamicallySizedBase",
					   _type.baseType()->isDynamicallySized())("arrayLen", toCompactHexWithPrefix(_type.length()))(
					   "accessCalldataTail",
					   _type.baseType()->isDynamicallyEncoded() ? accessCalldataTailFunction(*_type.baseType()) : "")
				.render();
		});
}
				...
				<?dynamicallySized>
					...
					if sgt(addr, sub(calldatasize(), mul(length, <calldataStride>))) { <shortCalldataTail>() }
					   ...
					   toCompactHexWithPrefix(
						   _type.isDynamicallySized() ? dynamic_cast<ArrayType const&>(_type).calldataStride() : 0))(
...
string YulUtilFunctions::copyArrayFromStorageToMemoryFunction(ArrayType const& _from, ArrayType const& _to)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			)")("functionName", functionName)("allocateUnbounded", allocateUnboundedFunction())(
						   "encode",
			...
			)")("functionName", functionName)("lengthFunction", arrayLengthFunction(_from))(
						   "allocateArray",
						   allocateMemoryArrayFunction(_to))("arrayDataArea", arrayDataAreaFunction(_from))(
						   "dynamic",
						   _to.isDynamicallySized())("convert", conversionFunction(*_from.baseType(), *_to.baseType()))(
...
string YulUtilFunctions::bytesConcatFunction(vector<Type const*> const& _argumentTypes)
{
	...
	for (Type const* argumentType: _argumentTypes)
	{
		...
		else if (auto const* literalType = dynamic_cast<StringLiteralType const*>(argumentType);
		...
		[&]()
		{
			...
			templ(
				...
				ABIFunctions{m_evmVersion, m_revertStrings, m_functionCollector}
					.tupleEncoderPacked(_argumentTypes, targetTypes));
			return templ.render();
		});
}
...
string YulUtilFunctions::mappingIndexAccessFunction(MappingType const& _mappingType, Type const& _keyType)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			)")("functionName", functionName)("key", suffixedVariableNameList("key_", 0, _keyType.sizeOnStack()))(
						   "hash",
						   packedHashFunction(
							   {&_keyType, TypeProvider::uint256()}, {_mappingType.keyType(), TypeProvider::uint256()}))
					.render();
			else
			{
...
string YulUtilFunctions::readFromStorageDynamic(Type const& _type, bool _splitFunctionTypes)
{
	...
	string functionName
		= "read_from_storage__dynamic_" + string(_splitFunctionTypes ? "split_" : "") + _type.identifier();
	...
	return m_functionCollector.createFunction(
		...
		)")("functionName", functionName)("panic", panicFunction(util::PanicCode::Generic))(
...
string YulUtilFunctions::readFromStorageValueType(Type const& _type, optional<size_t> _offset, bool _splitFunctionTypes)
{
	...
	string functionName = "read_from_storage_" + string(_splitFunctionTypes ? "split_" : "")
						  + (_offset.has_value() ? "offset_" + to_string(*_offset) : "dynamic") + "_"
						  + _type.identifier();
...
string YulUtilFunctions::readFromStorageReferenceType(Type const& _type)
{
	if (auto const* arrayType = dynamic_cast<ArrayType const*>(&_type))
	{
		...
		return copyArrayFromStorageToMemoryFunction(
			dynamic_cast<ArrayType const&>(*arrayType->copyForLocation(DataLocation::Storage, false)), *arrayType);
	}
		...
		memberSetValues[i]["setMember"]
			= Whiskers(R"(
			{
				...
				<writeToMemory>(add(value, <memberMemoryOffset>), <memberValues>)
				  ...
				  "memberMemoryOffset",
				  structType.memoryOffsetOfMember(structMembers[i].name).str())("memberSlotDiff", memberSlotDiff.str())(
	...
	return m_functionCollector.createFunction(
		...
		[&]
		{
			...
			function <functionName>(slot) -> value {
				...
				functionName)("allocStruct", allocateMemoryStructFunction(structType))("member", memberSetValues)
				.render();
		});
}

string YulUtilFunctions::readFromMemory(Type const& _type) { return readFromMemoryOrCalldata(_type, false); }

string YulUtilFunctions::readFromCalldata(Type const& _type) { return readFromMemoryOrCalldata(_type, true); }

string YulUtilFunctions::updateStorageValueFunction(
	Type const& _fromType, Type const& _toType, std::optional<unsigned> const& _offset)
{
	string const functionName = "update_storage_value_" + (_offset.has_value() ? ("offset_" + to_string(*_offset)) : "")
								+ _fromType.identifier() + "_to_" + _toType.identifier();
		...
		[&]
		{
			if (_toType.isValueType())
			{
				...
				function <functionName>(slot, <offset><fromValues>) {
					...
					sstore(slot, <update>(sload(slot), <offset><prepare>(<toValues>)))
						   ...
						   "update",
						   _offset.has_value() ? updateByteSliceFunction(_toType.storageBytes(), *_offset)
											   : updateByteSliceFunctionDynamic(_toType.storageBytes()))(
						   "offset",
						   _offset.has_value() ? "" : "offset, ")("convert", conversionFunction(_fromType, _toType))(
			...
			if (!fromReferenceType)
			{
				...
				function <functionName>(slot<?dynamicOffset>, offset</dynamicOffset>) {
					...
					functionName)("dynamicOffset", !_offset.has_value())("panic", panicFunction(PanicCode::Generic))(
						   "copyToStorage",
						   copyLiteralToStorageFunction(dynamic_cast<StringLiteralType const&>(_fromType).value()))
					.render();
			}

			solAssert(
				*toReferenceType->copyForLocation(fromReferenceType->location(), fromReferenceType->isPointer()).get()
					== *fromReferenceType,
				"");
			...
			if (_fromType.category() == Type::Category::Array)
				templ(
					"copyToStorage",
					copyArrayToStorageFunction(
						dynamic_cast<ArrayType const&>(_fromType), dynamic_cast<ArrayType const&>(_toType)));
			else if (_fromType.category() == Type::Category::ArraySlice)
			{
				...
				templ(
					"copyToStorage",
					copyStructToStorageFunction(
						dynamic_cast<StructType const&>(_fromType), dynamic_cast<StructType const&>(_toType)));
...
string YulUtilFunctions::writeToMemoryFunction(Type const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]
		{
			...
			{
				solAssert(ref->location() == DataLocation::Memory, "Can only update types with location memory.");
...
{
	string functionName = "extract_from_storage_value_dynamic" + _type.identifier();
	return m_functionCollector.createFunction(
		functionName,
		[&]
		{
			...
			function <functionName>(slot_value, offset) -> value {
				...
				functionName)("shr", shiftRightFunctionDynamic())("cleanupStorage", cleanupFromStorageFunction(_type))
				.render();
		});
}
...
string YulUtilFunctions::allocateUnboundedFunction()
{
	...
	return m_functionCollector.createFunction(
		...
		)")("freeMemoryPointer", to_string(CompilerUtils::freeMemoryPointer))("functionName", functionName)
				.render();
		});
}
...
string YulUtilFunctions::finalizeAllocationFunction()
{
	...
	return m_functionCollector.createFunction(
		...
		)")("functionName", functionName)("freeMemoryPointer", to_string(CompilerUtils::freeMemoryPointer))(
					   "roundUp", roundUpFunction())("panic", panicFunction(PanicCode::ResourceError))
				.render();
		});
}
			...
			return Whiskers(R"(
				function <functionName>(length) -> memPtr {
					...
					mstore(memPtr, length)
					   ...
					   "allocSize", arrayAllocationSizeFunction(_type))("dynamic", _type.isDynamicallySized())
				.render();
		});
}
			...
			return Whiskers(R"(
				function <functionName>(length) -> memPtr {
					...
					<zeroArrayFunction>(dataStart, dataSize)
					   ...
					   "zeroArrayFunction", zeroMemoryArrayFunction(_type))("dynamic", _type.isDynamicallySized())
				.render();
		});
}
		...
		function <functionName>() -> memPtr {
			...
			for (size_t i = 0; i < members.size(); ++i)
			{
				...
				memberParams[i]["zeroValue"] = zeroValueFunction(
					*TypeProvider::withLocationIfReference(DataLocation::Memory, members[i]), false);
			}
...
string YulUtilFunctions::conversionFunction(Type const& _from, Type const& _to)
{
	if (_from.category() == Type::Category::Function)
	{
		...
		solAssert(
			fromType.isImplicitlyConvertibleTo(targetType) && fromType.sizeOnStack() == targetType.sizeOnStack()
		...
		return m_functionCollector.createFunction(
			...
			)")("functionName", functionName)("external", fromType.kind() == FunctionType::Kind::External)
					.render();
			});
	}
	else if (_from.category() == Type::Category::ArraySlice)
	{
		...
		solAssert(
			fromType.arrayType().dataStoredIn(DataLocation::CallData) && fromType.arrayType().isDynamicallySized()
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			case Type::Category::Address:
			case Type::Category::Contract:
				body = Whiskers("converted := <convert>(value)")("convert", conversionFunction(IntegerType(160), _to))
						   .render();
				break;
			case Type::Category::Integer:
			case Type::Category::RationalNumber:
			{
				...
				if (toCategory == Type::Category::FixedBytes)
				{
					...
					body = Whiskers("converted := <shiftLeft>(<clean>(value))")(
							   "shiftLeft",
							   shiftLeftFunction(256 - toBytesType.numBytes() * 8))("clean", cleanupFunction(_from))
							   .render();
				}
				else if (toCategory == Type::Category::Enum)
					body = Whiskers("converted := <cleanEnum>(<cleanInt>(value))")("cleanEnum", cleanupFunction(_to))(
					...
					body = Whiskers(
							   "converted := <convert>(value)")("convert", conversionFunction(_from, IntegerType(160)))
							   .render();
				else if (toCategory == Type::Category::Integer)
				{
					...
					body = Whiskers("converted := <cleanInt>(value)")("cleanInt", cleanupFunction(*cleanupType))
							   .render();
				}
				else
					solAssert(false, "");
			...
			case Type::Category::Bool:
			{
				...
				body = Whiskers("converted := <clean>(value)")("clean", cleanupFunction(_from)).render();
				break;
			}
			case Type::Category::FixedPoint:
				solUnimplemented("Fixed point types not implemented.");
				...
				else
				{
					...
					if (fromStructType.location() == DataLocation::CallData)
						...
						converted := <abiDecode>(value, calldatasize())
							...
							ABIFunctions(m_evmVersion, m_revertStrings, m_functionCollector)
								.abiDecodingFunctionStruct(toStructType, false))
								   .render();
					else
					{
			...
			case Type::Category::FixedBytes:
			{
				...
				if (toCategory == Type::Category::Integer)
					body = Whiskers("converted := <convert>(<shift>(value))")(
							   ...
							   shiftRightFunction(
								   256
								   - from.numBytes()
										 * 8))("convert", conversionFunction(IntegerType(from.numBytes() * 8), _to))
							   .render();
				...
				else
				{
					...
					body = Whiskers("converted := <clean>(value)")("clean", cleanupFunction(from)).render();
				}
				break;
			}
			...
			case Type::Category::Enum:
			{
				...
				body = Whiskers("converted := <clean>(value)")("clean", cleanupFunction(enumType)).render();
				break;
			}
			...
			case Type::Category::TypeType:
			{
				...
				if (auto const* contractType = dynamic_cast<ContractType const*>(typeType.actualType());
					contractType->contractDefinition().isLibrary() && _to == *TypeProvider::address())
					body = "converted := value";
				else
	...
	return m_functionCollector.createFunction(
		...
		[&](auto& _args, auto& _returnParams)
		{
			...
			if (fromCalldata)
				...
				templ(
					"extractValue",
					_from.dataStoredIn(DataLocation::Storage) ? readFromStorage(_to, 32 - _to.numBytes(), false)
															  : readFromMemory(_to));
...
string YulUtilFunctions::copyStructToStorageFunction(StructType const& _from, StructType const& _to)
{
	...
	string functionName = "copy_struct_to_storage_from_" + _from.identifier() + "_to_" + _to.identifier();

	return m_functionCollector.createFunction(
		functionName,
		[&](auto& _arguments, auto&)
		{
			...
			for (size_t i = 0; i < structMembers.size(); ++i)
			{
				...
				t("updateStorageValue",
				  updateStorageValueFunction(memberType, *toStructMembers[i].type, optional<unsigned>{offset}));
...
string YulUtilFunctions::arrayConversionFunction(ArrayType const& _from, ArrayType const& _to)
{
	if (_to.dataStoredIn(DataLocation::CallData))
		solAssert(_from.dataStoredIn(DataLocation::CallData) && _from.isByteArray() && _to.isByteArray(), "");
	...
	string functionName = "convert_array_" + _from.identifier() + "_to_" + _to.identifier();
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			if (_from == _to || (_from.dataStoredIn(DataLocation::Memory) && _to.dataStoredIn(DataLocation::Memory))
				...
				templ(
					...
					_from.dataStoredIn(
						DataLocation::Storage))("fromCalldata", _from.dataStoredIn(DataLocation::CallData))(
		...
		[&]()
		{
			...
			case Type::Category::Integer:
			{
				...
				if (type.numBits() == 256)
					...
					templ(
						"body",
						"cleaned := and(value, " + toCompactHexWithPrefix((u256(1) << type.numBits()) - 1) + ")");
				break;
			}
			case Type::Category::RationalNumber:
				templ("body", "cleaned := value");
			...
			case Type::Category::Mapping:
				solAssert(
					_type.dataStoredIn(DataLocation::Storage), "Cleanup requested for non-storage reference type.");
				templ("body", "cleaned := value");
				break;
			case Type::Category::FixedBytes:
			{
			...
			case Type::Category::Contract:
			{
				AddressType addressType(
					dynamic_cast<ContractType const&>(_type).isPayable() ? StateMutability::Payable
...
string
YulUtilFunctions::packedHashFunction(vector<Type const*> const& _givenTypes, vector<Type const*> const& _targetTypes)
{
		...
		[&]()
		{
			...
			function <functionName>(value) -> ret {
				...
				ret := sub(value, 1)
					   ...
					   "minval", toCompactHexWithPrefix(type.min()))("cleanupFunction", cleanupFunction(_type))
				.render();
		});
}
...
std::string YulUtilFunctions::decrementWrappingFunction(Type const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		)")("functionName", functionName)("cleanupFunction", cleanupFunction(type))
				.render();
		});
}
...
std::string YulUtilFunctions::incrementCheckedFunction(Type const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		)")("functionName", functionName)("maxval", toCompactHexWithPrefix(type.max()))(
					   "panic", panicFunction(PanicCode::UnderOverflow))("cleanupFunction", cleanupFunction(_type))
				.render();
		});
}
...
string YulUtilFunctions::negateNumberCheckedFunction(Type const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		)")("functionName", functionName)("minval", toCompactHexWithPrefix(type.min()))(
					   "cleanupFunction", cleanupFunction(_type))("panic", panicFunction(PanicCode::UnderOverflow))
				.render();
		});
}
...
string YulUtilFunctions::zeroValueFunction(Type const& _type, bool _splitFunctionTypes)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			...
			{
				solAssert(_type.category() == Type::Category::Struct || _type.category() == Type::Category::Array, "");
				Whiskers templ(R"(
...
string YulUtilFunctions::storageSetToZeroFunction(Type const& _type)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			if (_type.isValueType())
			...
			)")("functionName", functionName)("store", updateStorageValueFunction(_type, _type))(
				...
				function <functionName>(slot, offset) {
					...
					functionName)("clearArray", clearStorageArrayFunction(dynamic_cast<ArrayType const&>(_type)))(
				...
				function <functionName>(slot, offset) {
					...
					functionName)("clearStruct", clearStorageStructFunction(dynamic_cast<StructType const&>(_type)))(
						   "panic", panicFunction(PanicCode::Generic))
					.render();
			else
...
string YulUtilFunctions::conversionFunctionSpecial(Type const& _from, Type const& _to)
{
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			if (auto fromTuple = dynamic_cast<TupleType const*>(&_from), toTuple = dynamic_cast<TupleType const*>(&_to);
				...
				for (size_t i = 0; i < fromTuple->components().size(); ++i)
				{
					...
					if (toComponent)
					{
						conversions += suffixedVariableNameList(
										   "converted", destStackSize, destStackSize + toComponent->sizeOnStack())
									   + (toComponent->sizeOnStack() > 0 ? " := " : "")
									   + conversionFunction(*fromComponent, *toComponent) + "("
									   + suffixedVariableNameList(
										   "value", sourceStackSize, sourceStackSize + fromComponent->sizeOnStack())
									   + ")\n";
			...
			)")("functionName", functionName)("values", suffixedVariableNameList("value", 0, sourceStackSize))(
						   "arrow", destStackSize > 0 ? "->" : "")(
						   "converted",
						   suffixedVariableNameList("converted", 0, destStackSize))("conversions", conversions)
					.render();
			}
			...
			if (_to.category() == Type::Category::FixedBytes)
			{
				...
				templ("functionName", functionName);
				templ("data", formatNumber(h256::Arith(h256(data, h256::AlignLeft)) & (~(u256(-1) >> (8 * numBytes)))));
				return templ.render();
			}
			else if (_to.category() == Type::Category::Array)
			{
				...
				solAssert(false, "Invalid conversion from string literal to " + _to.toString() + " requested.");
		});
}

string YulUtilFunctions::readFromMemoryOrCalldata(Type const& _type, bool _fromCalldata)
{
	string functionName = string("read_from_") + (_fromCalldata ? "calldata" : "memory") + _type.identifier();
...
string YulUtilFunctions::revertReasonIfDebugBody(
	RevertStrings _revertStrings, string const& _allocation, string const& _message)
{
...
string YulUtilFunctions::panicFunction(util::PanicCode _code)
{
	...
	return m_functionCollector.createFunction(
		...
		)")("functionName", functionName)("selector", util::selectorFromSignature("Panic(uint256)").str())(
			...
			function <functionName>() -> data {
				...
				<!supportsReturndata>
					data := <emptyArray>()
					   ...
					   "allocateArray",
					   allocateMemoryArrayFunction(
						   *TypeProvider::bytesMemory()))("emptyArray", zeroValueFunction(*TypeProvider::bytesMemory()))
				.render();
		});
}

string YulUtilFunctions::copyConstructorArgumentsToMemoryFunction(
	ContractDefinition const& _contract, string const& _creationObjectName)
{
	string functionName = "copy_arguments_for_constructor_" + toString(_contract.constructor()->id()) + "_object_"
						  + _contract.name() + "_" + toString(_contract.id());
	...
	return m_functionCollector.createFunction(
		...
		[&]()
		{
			string returnParams = suffixedVariableNameList(
				"ret_param_", 0, CompilerUtils::sizeOnStack(_contract.constructor()->parameters()));
			...
			function <functionName>() -> <retParams> {
				...
				<retParams> := <abiDecode>(memoryDataOffset, add(memoryDataOffset, argSize))
					   ...
					   "abiDecode",
					   abiFunctions.tupleDecoder(FunctionType(*_contract.constructor()).parameterTypes(), true))
				.render();
		});
}
...
string YulUtilFunctions::externalCodeFunction()
{
	...
	return m_functionCollector.createFunction(
		...
		)")("functionName", functionName)("allocateArray", allocateMemoryArrayFunction(*TypeProvider::bytesMemory()))
				.render();
		});
}
